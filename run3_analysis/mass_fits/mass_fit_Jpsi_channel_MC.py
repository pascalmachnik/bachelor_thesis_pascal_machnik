...
alphar1 = r.RooRealVar("signal_alphaR1", "signal_alphaR1", 1.5, 0.1, 7.0)
...
alphal2 = r.RooRealVar("signal_alphaL2", "signal_alphaL2", 4, 0.1, 7.0)
alphar2 = r.RooRealVar("signal_alphaR2", "signal_alphaR2", 4, 0.1, 7.0)
nL2 = r.RooRealVar("signal_nL2", "signal_nL2", 2, 0.1, 7.5)
nR2 = r.RooRealVar("signal_nR2", "signal_nR2", 2, 0.1, 7.0)
...
# Create a RooDataSet
df.Snapshot("DecayTree", f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_jpsi_mc.root", ["Lambdab_DTF_LambdaJpsi_PV_M"])
f = r.TFile(f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_jpsi_mc.root")
...
os.remove(f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_jpsi_mc.root")
