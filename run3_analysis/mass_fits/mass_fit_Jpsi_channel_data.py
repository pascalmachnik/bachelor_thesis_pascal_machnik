...
misID_mean = r.RooRealVar("misID_mean", "misID_mean", 5400, 5425, 5455)
misID_sigma = r.RooRealVar("misID_sigma", "misID_sigma", 15, 0.5, 35)
...
signal_yield = r.RooRealVar("signal_yield", "Signal yield", 1000, 10, 1e6)
combinatorial_yield = r.RooRealVar("comb_yield", "Combinatorial yield", 50000, 10, 1e6)
misID_yield = r.RooRealVar("misID_yield", "MisID yield", 50000, 10, 56e3)
...
# Create a RooDataSet
df.Snapshot("DecayTree", f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_data.root", branches)
f = r.TFile(f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_data.root")
...
if os.path.exists(f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_data.root"):
    os.remove(f"/ceph/users/pmachnik/temp/R3_{args.BDTG}_{args.track_type}_temp_data.root")
