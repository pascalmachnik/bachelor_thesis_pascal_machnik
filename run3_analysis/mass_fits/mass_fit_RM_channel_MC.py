...
df = r.RDataFrame("DecayTree", args.input, ["Lambdab_DTF_Lambda_PV_M", "BDTG"])
...
mass = r.RooRealVar("Lambdab_DTF_Lambda_PV_M", "m_{#Lambda_{b}}", 5300, 5940)
...
alphal1 = r.RooRealVar("signal_alphaL1", "signal_alphaL1", 4, 2, 20)
alphar1 = r.RooRealVar("signal_alphaR1", "signal_alphaR1", 2, 0.1, 10)
nL1 = r.RooRealVar("signal_nL1", "signal_nL1", 0.1, 0.001, 5)
nR1 = r.RooRealVar("signal_nR1", "signal_nR1", 1, 0.1, 2)
...
alphal2 = r.RooRealVar("signal_alphaL2", "signal_alphaL2", 2, 0.1, 20)
alphar2 = r.RooRealVar("signal_alphaR2", "signal_alphaR2", 2, 0.1, 20)
nL2 = r.RooRealVar("signal_nL2", "signal_nL2", 2, 0.1, 20)
nR2 = r.RooRealVar("signal_nR2", "signal_nR2", 0.1, 0, 10)
...
# Create a RooDataSet
df.Snapshot("DecayTree", f"/ceph/users/pmachnik/temp/r3_{args.track_type}_temp_rm_mc.root", ["Lambdab_DTF_Lambda_PV_M"])
f = r.TFile(f"/ceph/users/pmachnik/temp/r3_{args.track_type}_temp_rm_mc.root")
...
r.gStyle.SetStatFontSize(0.06) # Set the stat font size
...
os.remove(f"/ceph/users/pmachnik/temp/r3_{args.track_type}_temp_rm_mc.root")
