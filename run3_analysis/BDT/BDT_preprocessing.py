...
df_s = df_filter(df_s, "preselection")
...
df_s_ll = BDT_define(df_s_ll)
df_s_dd = BDT_define(df_s_dd)
...
# Cuts on the BDT variabled in order to improve the range for BDT training
df_s_dd = df_s_dd.Filter("Lambdab_BPVLTIME < 0.01")
df_b_dd = df_b_dd.Filter("Lambdab_BPVLTIME < 0.01")
df_s_dd = df_s_dd.Filter("Lambdab_DTF_Lambda_CHI2DOF < 20")
df_b_dd = df_b_dd.Filter("Lambdab_DTF_Lambda_CHI2DOF < 20")
df_s_dd = df_s_dd.Filter("log10_Lambdab_BPVDIRA > -0.25")
df_b_dd = df_b_dd.Filter("log10_Lambdab_BPVDIRA > -0.25")
df_s_dd = df_s_dd.Filter("Lambda_BPVFDCHI2 < 3500")
df_b_dd = df_b_dd.Filter("Lambda_BPVFDCHI2 < 3500")
df_s_dd = df_s_dd.Filter("Lambda_BPVIPCHI2 < 21")
df_b_dd = df_b_dd.Filter("Lambda_BPVIPCHI2 < 21")
df_s_ll = df_s_ll.Filter("Pion_BPVIPCHI2 < 2700")
df_b_ll = df_b_ll.Filter("Pion_BPVIPCHI2 < 2700")

df_s_ll = df_s_ll.Filter("Lambdab_BPVLTIME < 0.01")
df_b_ll = df_b_ll.Filter("Lambdab_BPVLTIME < 0.01")
df_s_ll = df_s_ll.Filter("Lambdab_DTF_Lambda_CHI2DOF < 30")
df_b_ll = df_b_ll.Filter("Lambdab_DTF_Lambda_CHI2DOF < 30")
df_s_ll = df_s_ll.Filter("log10_Lambdab_BPVDIRA > -0.25")
df_b_ll = df_b_ll.Filter("log10_Lambdab_BPVDIRA > -0.25")
df_s_ll = df_s_ll.Filter("Lambda_BPVFDCHI2 < 400000")
df_b_ll = df_b_ll.Filter("Lambda_BPVFDCHI2 < 400000")
df_s_ll = df_s_ll.Filter("Lambda_BPVIPCHI2 < 800")
df_b_ll = df_b_ll.Filter("Lambda_BPVIPCHI2 < 800")
df_s_ll = df_s_ll.Filter("Lambda_BPVFD < 800")
df_b_ll = df_b_ll.Filter("Lambda_BPVFD < 800")
df_s_ll = df_s_ll.Filter("Pion_BPVIPCHI2 < 5000")
df_b_ll = df_b_ll.Filter("Pion_BPVIPCHI2 < 5000")
