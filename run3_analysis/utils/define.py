...
def BDT_define(df, corrected=False, run3=True):
    """
    ...
    if run3:
        definitions = {
            "q2": "(pow(L1_PE+L2_PE,2) - pow(L1_PX+L2_PX,2) - pow(L1_PY+L2_PY,2) - pow(L1_PZ+L2_PZ,2))/1000000",
            ...
            "ProbNNmu_max": "max(L1_PROBNN_MU, L2_PROBNN_MU)",
            "ProbNNmu_min": "min(L1_PROBNN_MU, L2_PROBNN_MU)",
            "chi2ip_max": "max(L1_BPVIPCHI2, L2_BPVIPCHI2)",
            "chi2ip_min": "min(L1_BPVIPCHI2, L2_BPVIPCHI2)",
            "chi2ip_min_pi_p": "min(Pion_BPVIPCHI2, Proton_BPVIPCHI2)",
            ...
            "log10_Lambdab_BPVDIRA": "log10(Lambdab_BPVDIRA)",
