...
df = df_filter(df, "fit_range_RM_1516")
...
mass = r.RooRealVar("Lambdab_LOKI_MASS_LConstr", "m_{#Lambda_{b}}", 5400, 5800)
...
alphal1 = r.RooRealVar("signal_alphaL1", "signal_alphaL1", 1.5, 0.1, 11)
alphar1 = r.RooRealVar("signal_alphaR1", "signal_alphaR1", 1.5, 0.1, 6)
nL1 = r.RooRealVar("signal_nL1", "signal_nL1", 0.2, 0.01, 5)
nR1 = r.RooRealVar("signal_nR1", "signal_nR1", 1, 0.01, 20)
...
alphal2 = r.RooRealVar("signal_alphaL2", "signal_alphaL2", 2, 0.1, 5)
alphar2 = r.RooRealVar("signal_alphaR2", "signal_alphaR2", 2, 0.1, 5)
nL2 = r.RooRealVar("signal_nL2", "signal_nL2", 0.2, 0.1, 4)
nR2 = r.RooRealVar("signal_nR2", "signal_nR2", 2, 0.1, 10)
