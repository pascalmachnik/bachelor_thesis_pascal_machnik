...
void addL0Muonweights_Run2(TString tuple) {
  ...
  TBranch *newbranch = newTree->Branch("L0MuonWeight_Run2_v1", &L0Weight, "L0MuonWeight_Run2_v1/D");
  TBranch *newbranch_b = newTree->Branch("L0MuonWeight_Run2_v1_b", &L0Weight_b, "L0MuonWeight_Run2_v1_b/D");
  TBranch *newbranch_err = newTree->Branch("L0MuonWeight_Run2_v1_err", &L0Weight_err, "L0MuonWeight_Run2_v1_err/D");

  //read the files with weights
  TFile* weightsFile_18 = new TFile("/ceph/users/jnicolini/scripts/Lambdab/Calibration/2023_fixes/2018/L0Muon_and_L0DiMuonweights_18_2023fixes_morebins.root","READ");
  TFile* weightsFile_17 = new TFile("/ceph/users/jnicolini/scripts/Lambdab/Calibration/2023_fixes/2017/L0Muon_and_L0DiMuonweights_17_2023fixes_morebins.root","READ");
  TFile* weightsFile_16 = new TFile("/ceph/users/jnicolini/scripts/Lambdab/Calibration/2023_fixes/2016/L0Muon_and_L0DiMuonweights_16_2023fixes_morebins.root","READ");
  TFile* weightsFile_15 = new TFile("/ceph/users/jnicolini/scripts/Lambdab/Calibration/2023_fixes/2015/L0Muon_and_L0DiMuonweights_15_2023fixes_morebins.root","READ");
