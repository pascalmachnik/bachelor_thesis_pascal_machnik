...
signal_sigma = r.RooRealVar("signal_sigma", "signal_sigma", 10, 1, 40)
...
comb_slope = r.RooRealVar("comb_slope", "comb_slope", 0.1, 0, 10)
comb_intercept = r.RooRealVar("comb_intercept", "comb_intercept", -200, -3000, 0)
comb_bkg = r.RooGenericPdf(
    "comb_bkg",
    "Combinatorial background model",
    "comb_intercept + comb_slope * Lambdab_LOKI_MASS_LConstr",
    r.RooArgList(comb_intercept, comb_slope, mass)
)
...
legend = r.TLegend(0.6, 0.25, 0.9, 0.45)
