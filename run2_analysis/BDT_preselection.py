...
branches = [
    ...
    "Lambdab_LOKI_MASS_LConstr", "Pion_TRACK_Type", "Proton_TRACK_Type",
]

if args.sample == "MC":
    branches.append("L1_ProbNNmu_pidcorr_default")
    branches.append("L2_ProbNNmu_pidcorr_default")
...
if args.sample == "MC":
    ...
    df = df_filter(df, "preselection_corr")
    df = df_filter(df, args.track_type)
    df = BDT_define(df, corrected=True)
