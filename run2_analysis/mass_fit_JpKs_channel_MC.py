...
# Create a RooDataSet
df.Snapshot("DecayTree", f"/ceph/users/pmachnik/temp/{args.BDTG}_{args.track_type}_temp_jpks_MC.root", ["Lambdab_LOKI_MASS_AllConstr"])
f = r.TFile(f"/ceph/users/pmachnik/temp/{args.BDTG}_{args.track_type}_temp_jpks_MC.root")
...
os.remove(f"/ceph/users/pmachnik/temp/{args.BDTG}_{args.track_type}_temp_jpks_MC.root")
